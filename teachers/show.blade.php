    ...
    <div class="tab-pane fade in active show" id="mainProfile1" role="tabpanel">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-12">
                ...
                <?php $image_path = ($teacher->picture != null ? $teacher->picture : 'user-default.png'); ?>
                    <img alt="" src="{{ asset('img/users') }}/{{ $image_path }}" srcset="" class="avatar avatar-160 photo" height="160" width="160">
                    ...
                    <div class="card-body">
                        <!--Title-->
                        <h4 class="card-title">
                            <strong>{{$teacher->name_initials}}</strong>
                        </h4>
                        <h5>
                        ...
                        <a class="btn btn-primary btn-md blue white-text" href="{{route('academic.teachers.edit', ['teacher' => $teacher->id])}}" role="button">Edit profile
