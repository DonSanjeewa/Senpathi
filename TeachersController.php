...
class TeachersController extends Controller
{
    ...
    public function edit(Teacher $teacher)
    {
        ...
        $allRecords = $allRecords[0];
        $teacher_experience = $teacher_experience[0];
        ...
        return view('academic.teachers.edit', compact("allRecords","teacher_experience","teacher_professional_qualifications","teacher_educational_qualifications","user_role","nationalities","religions","designations","sections","subjects","serviceGrades","academicRoles","roles","hasData"));
    }
